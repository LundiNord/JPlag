...
# Read the data
data <- read.csv("results/AI_plagiarism_Unrelated_results_Standard.csv")
data1 <- read.csv("results/AI_plagiarism_Unrelated_results_Level1.csv")
data2 <- read.csv("results/AI_plagiarism_Unrelated_results_Level2.csv")
