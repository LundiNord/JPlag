...
//------------------------------------------------------------------Leitura de valores--------------------------------------------------------------------------------------------------------
		for(int j=0;j<p;j++){
				if(binarySearch(somas,pg[j],h)==10000)
					...
					if(calculo2!=0 && calculo3!=0 && Math.abs(calculo1-pg[j])<Math.abs(calculo2-pg[j]) && Math.abs(calculo1-pg[j])<Math.abs(calculo3-pg[j]))
					...
					else if(Math.abs(calculo1-pg[j])==Math.abs(calculo2-pg[j])||Math.abs(calculo1-pg[j])==Math.abs(calculo3-pg[j])||Math.abs(calculo2-pg[j])==Math.abs(calculo3-pg[j])){
						if(Math.abs(calculo1-pg[j])==Math.abs(calculo2-pg[j]) && calculo1!=calculo2){
						...
						if(doIt == 0 && Math.abs(calculo1-pg[j])==Math.abs(calculo3-pg[j]) && calculo1==calculo3){
