...
public class StringCharInclValue extends JavaObject implements IStringValue {
    ...
    @Override
    public StringCharInclValue merge(@NotNull IValue other, Set<JavaObject> visited) {
        return merge(other);
    }

    @Override
    public StringCharInclValue merge(@NotNull IValue other) {
        // if (other instanceof VoidValue) {
    ...
    public IValue getInitialValue() {
        return new StringCharInclValue(null, new BitSet());
    }
